...
UCLASS(ClassGroup=Camera, hideCategories=(Mobility), MinimalAPI)
class USBSpringArmComponent : public USceneComponent
{
	GENERATED_BODY()

	USBSpringArmComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
